...
$i++;
$cfg['Servers'][$i]['host'] 			= 'pruebakone-6b26cbde334342db943a38bfea1be1d0-dbserver.mysql.database.azure.com';
$cfg['Servers'][$i]['port'] 			= '';
$cfg['Servers'][$i]['connect_type'] 	= 'tcp';
$cfg['Servers'][$i]['socket'] 			= '';
$cfg['Servers'][$i]['AllowNoPassword']	= false;   // true/false
$cfg['blowfish_secret']					= 'NPE(1f]\"APt%2V[eVw\"UJV)nHN!V#HqC' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_j3oxE8utvFKOlDYc4qa7AkL/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://pruebakonectajonathan.azurewebsites.net/wp-admin/?rand=51272043&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://pruebakonectajonathan.azurewebsites.net/wp-admin/?rand=51279440&pma_logout=1';
